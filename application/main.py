from application.custome.gmail_custom_api import EmailInteraction


def main():
    emailInteraction = EmailInteraction("19GFEhbZ0KlWknhEw6Js0mCEeIwNQgVeif-3Bw_yFpVs")
    print(emailInteraction.get_reminders_from_document())
    print(emailInteraction.service)
